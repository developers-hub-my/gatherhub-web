...
const variants = {
  primary: clsx(
    ...
    'dark:bg-blue-600 dark:data-hover:bg-blue-500',
  ),
  secondary: clsx(
    'relative inline-flex items-center justify-center px-4 py-[calc(--spacing(2)-1px)]',
    'rounded-full border border-transparent bg-white/15 shadow-md ring-1 ring-[#3b82f6]/15',
    ...
    'dark:bg-white/10 dark:text-white dark:ring-white/20 dark:data-hover:bg-white/15',
  ),
  outline: clsx(
    ...
    'dark:ring-white/20 dark:text-white dark:data-hover:bg-white/10',
  ),
}
